...
const FAQ = () => {
  ...
  return (
    <div>
      <section className="bg-[#eef0f4] rounded-2xl mx-10">
        <div className="py-16  md:py-24 lg:py-32 mx-auto w-full max-w-7xl px-5 md:px-10">
          <div className="flex flex-col items-start lg:flex-row lg:space-x-20">
            ...
            <div className="flex-[1_1_500px] overflow-y-auto scrollbar-hide h-[60vh]  max-[991px]:w-full max-[991px]:flex-none">
              {faqData.map((faq, index) => (
                <div
                  key={index}
                  className={`mb-6 w-full ${
                    openIndex === index ? "bg-blue-500 text-white duration-300" : `bg-${faq.color} `
                  } text-black overflow-hidden p-8 rounded-${
                    faq.rounded ? "2xl" : "sm"
                  }`}
                >
                  <div
