    ...
    return (
        <div className="flex items-center  justify-center h-screen">
            <section className="relative  bg-white ">
                ...
                <div class="flex justify-center flex-wrap w-full gap-6 pb-8 mt-12  sm:mt-16 lg:mt-20 snap-x">



                    <div class="relative snap-center  shrink-0 f ">
                        <div class="w-[400px] lg:w-[420px] transition-all duration-200 transform bg-white border border-gray-200 rounded-2xl hover:shadow-lg hover:-translate-y-1">
                    ...
                    <div class="relative snap-center scroll-ml-6 shrink-0 ">
                        <div class="w-[400px] lg:w-[420px] transition-all duration-200 transform bg-white border border-gray-200 rounded-2xl hover:shadow-lg hover:-translate-y-1">
                            <div class="px-4 py-5 sm:p-5">
                                <div class="flex items-center">
                                    <a href="#" title="" class="shrink-0">
