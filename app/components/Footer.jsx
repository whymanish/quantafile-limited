  ...
  return (
    ...
    <div class="md:px-12 lg:px-28">
      <div class="container m-auto space-y-6 text-gray-600 dark:text-gray-300">
        ...
        <ul
          role="list"
          class="flex  items-center justify-center gap-4 py-4 flex-row sm:gap-8"
        >
          <li role="listitem"><a href="#" class="hover:text-primary">About</a></li>
          <li role="listitem"><a href="#" class="hover:text-primary">Contact us</a></li>
          <li role="listitem"><a href="#" class="hover:text-primary">T&C</a></li>
        </ul>
