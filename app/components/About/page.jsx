      ...
      <section>
        <div class="mx-auto w-full max-w-7xl px-5 py-16 md:px-10 md:py-16 lg:py-16">
          <div class="grid gap-10 lg:grid-cols-2 lg:gap-12">
            <img src="https://images.unsplash.com/photo-1637825891028-564f672aa42c?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="" class="inline-block h-full w-full rounded-3xl object-cover" />
            <div class="flex flex-col gap-5 rounded-3xl border  border-gray-300 p-10 sm:p-20">
              <h2 class="text-3xl text-gray-800 font-semibold tracking-tighter md:text-5xl">What we do ?</h2>
        ...
        <div className="px-8 py-12 mx-auto md:px-12 lg:px-32 max-w-7xl">
          <div className='text-center'>
            <p className="mt-12 text-4xl font-semibold tracking-tighter text-gray-900 lg:text-5xl">
              Meet our <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-cyan-600">
                Team
              </span>
          ...
          <ul role="list" className="grid max-w-2xl grid-cols-1 gap-6 mx-auto mt-12 sm:gap-4 lg:max-w-none lg:grid-cols-3">
              ...
              <figure className="relative flex flex-col justify-between h-full p-6 bg-white border shadow-lg rounded-2xl">
                ...
                <figcaption className="relative flex items-center justify-between pt-6 mt-6">
                  ...
                  <div className="overflow-hidden rounded-full bg-gray-50">
                    <img alt="" src="https://images.unsplash.com/photo-1620641788421-7a1c342ea42e?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" decoding="async" data-nimg="future" className="object-cover h-14 w-14 " loading="lazy" />
                  </div>
                </figcaption>
              </figure>
            </li>
            ...
            <li className="p-2 border bg-gray-50 rounded-3xl">
              <figure className="relative flex flex-col justify-between h-full p-6 bg-white border shadow-lg rounded-2xl">
                ...
                <figcaption className="relative flex items-center justify-between pt-6 mt-6">
                  <div>
                    <div className="font-medium text-gray-900">Manishkumar Yadav</div>
                    <div className="mt-1 text-sm text-gray-500">
                      Not a CEO
                    </div>
                  </div>
          ...
          <div className="p-2 border bg-gray-50 rounded-3xl">
            <div className="p-10 text-center bg-white border shadow-lg md:p-20 rounded-3xl">
              <p className="text-4xl font-semibold tracking-tighter text-black">
                Checkout our{' '}<span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-cyan-600">Social media</span> handles
              </p>
              <div className='flex justify-center '>
                <div className='grid gap-4  mt-12 grid-cols-4'>
                  
                  <img className='w-10 h-10 ' src='https://www.svgrepo.com/show/354000/linkedin-icon.svg' alt='' />
                  <img className='w-10 h-10' src='https://www.svgrepo.com/show/512317/github-142.svg' alt='' />

                  <img className='w-10 h-10' src='https://www.svgrepo.com/show/303154/instagram-2016-logo.svg' alt='' />
                  <img className='w-10 h-10' src='https://seeklogo.com/images/T/twitter-x-logo-0339F999CF-seeklogo.com.png?v=638264860180000000' alt='' />
