...
const TestimonialItem = ({ text, imageSrc, name, role }) => (
  <li >
    ...
    <div className="mb-5 max-w-sm rounded-br-[99px] rounded-tl-[60px] rounded-tr-[99px] hover:duration-300 hover:shadow-xl border-b border-blue-200  bg-gradient-to-r from-gray-50 to-blue-50/50 px-8 py-6 md:mb-8">
